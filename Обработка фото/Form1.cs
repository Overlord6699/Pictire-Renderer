    ...
    public partial class Form1 : Form
    {
        ...
        private async void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if( openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                sw.Stop();
                Text = "Прошло " + sw.Elapsed.ToString();
            }
        }
        ...
        private void RunProcessing(Bitmap bitmap)
        {
            ...
            for (int i = 1; i < trackBar1.Maximum; i++)
            {
                ...
                {
                    var index = _rand.Next(pixels.Count);
                ...
                this.Invoke(new Action(() => { Text = "Обработка " + i.ToString() + "%"; }));
                Text = "Обработка " + i.ToString() + "%";
